...
tf.add_to_collection(tf.GraphKeys.LOSSES, regularizer(w1))
tf.add_to_collection(tf.GraphKeys.LOSSES, regularizer(w2))
tf.add_to_collection(tf.GraphKeys.LOSSES, regularizer(w3))
tf.add_to_collection(tf.GraphKeys.LOSSES, regularizer(w4))
tf.add_to_collection(tf.GraphKeys.LOSSES, regularizer(w5))
tf.add_to_collection(tf.GraphKeys.LOSSES, regularizer(w6))
